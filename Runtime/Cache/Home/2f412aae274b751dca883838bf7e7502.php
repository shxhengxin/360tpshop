                            ...
                            <form class="form-horizontal" action="<?php echo U('Home/user/login');?>" method="post" name="login" onsubmit="return doLogin()">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7" width="330">
                                        ...
                                        <img src="<?php echo U('Home/user/yzm');?>" onclick="this.src='/index.php/Home/user/yzm/?'+Math.random()" width="100" height="34" style="position:relative;left:320px;top:-34px;"/>
                            ...
                            <form class="form-horizontal ERform" action="<?php echo U('Home/user/reg');?>" method="post" name="" onsubmit="return doCheckER()">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" width="330">
                                        ...
                                        <img src="<?php echo U('Home/user/yzm1');?>" onclick="this.src='/index.php/Home/user/yzm1/?'+Math.random()" width="100" height="34" style="position:relative;left:288px;top:-34px;"/>
                    ...
                    <?php if($_COOKIE['name']== null): ?><div class="loginbefore nloginWrap" style="display: block;">
                        ...
                        <div class="loginafter loginWrap" style="display: block;">
		                        <span class="top-uname popUsername">
									<img src="/Public/uploads/photos/home/default.png" class="img-circle" style="width:30px;margin-right:8px;">用户:<?php echo (cookie('name')); ?></span>
                            <div class="popbox" style="display: block;">
                                <a class="top-uname popUsername">用户:<?php echo (cookie('name')); ?></a>
                                <ul class="topuserbox">
                                    ...
                                    <li><a href="<?php echo U('Home/user/loginOut');?>">退出登录</a></li>
                                </ul>
                            </div>
                        </div><?php endif; ?>
                </li>
